...
export async function createTorDocument(
  ...
  const children: Paragraph[] = [
    ...
    thPara(
      [
        thText(
          '๕.1  ผู้ขายจะต้องแจ้งกำหนดเวลาติดตั้งแล้วเสร็จพร้อมที่จะใช้งานและส่งมอบคอมพิวเตอร์ได้โดยทำเป็นหนังสือยื่นต่อผู้ซื้อ ณ '
        ),
        thText(val('', 15)),
    ...
    thPara(
      [
        thText(
          '๕.๒ ผู้ขายต้องออกแบบสถานที่ติดตั้งคอมพิวเตอร์รวมทั้งระบบอื่น ๆ ที่เกี่ยวข้องตามมาตรฐานของผู้ขาย'
        ),
      ],
      { left: 360, spaceAfter: 80 }
    ),
    thPara(
      [
        thText(
          '๕.๓  ผู้ขายต้องนำเสนอแผนการฝึกอบรมในรายละเอียด เช่น หัวข้อการฝึกอบรม ระยะเวลา คุณสมบัติผู้เข้ารับการอบรม วิทยากร'
        ),
      ],
      { left: 360, spaceAfter: 80 }
    ),
    thPara([thText('๕.๔  '), thText(val(conditions, 40))], {
      left: 360,
      spaceAfter: 80,
    }),
    spacer(80),
    ...
    thPara(
      [
        thText(
          '๖.๑ ผู้ขายจะต้องติดตั้งคอมพิวเตอร์ที่ขาย ให้ถูกต้องและครบถ้วนตาม ข้อกำหนด และพร้อมที่จะใช้งานได้ให้แก่สำนักงานภายใน'
        ),
    ...
    thPara(
      [
        thText(
          '๖.๒  ผู้ขายจะต้องจัดฝึกอบรมให้แก่เจ้าหน้าที่ของสำนักงาน จำนวนไม่น้อยกว่า'
        ),
